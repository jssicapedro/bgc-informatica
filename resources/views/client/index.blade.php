...
<nav class="navbar navbar-expand-lg fixed-top">
    ...
    <!-- Toggler -->
    <button class="navbar-toggler" type="button" aria-label="Toggle navigation" data-bs-toggle="collapse"
...
<div class="about">
    <div>
        <p> Somos uma loja especializada na venda de equipamentos e consumíveis informáticos, bem como na prestação de
            serviços de reparação e manutenção de dispositivos tecnológicos. Localizados na Avenida Manuel Xavier, nº 2,
            estamos ao seu dispor desde 2009, com o compromisso de oferecer soluções de qualidade, tanto para empresas
            como para clientes individuais.
            Ao longo dos anos, temos consolidado uma sólida reputação no mercado, pautando-nos por valores que são a
            base do nosso trabalho: rigor, experiência, atenção, dedicação e confiança. Estes princípios guiam todas as
    ...
    <div>
        ...
        <p> Seja para o seu negócio ou para o seu uso pessoal, temos as melhores opções e um serviço especializado para
            assegurar que os seus equipamentos informáticos funcionem de forma eficaz e segura. Estamos prontos para
            atender às suas necessidades, oferecendo a atenção personalizada que cada cliente merece, com a experiência
            e o conhecimento necessários para proporcionar soluções rápidas e eficientes.
            Conte connosco para as suas necessidades informáticas. O nosso compromisso com a excelência está refletido
            no serviço que prestamos, com a confiança de quem sabe que, desde 2009, estamos aqui para ajudar a otimizar
            e manter o seu equipamento sempre em ótimo estado. </p>
    ...
    <div class="galeria">
        <div class="row">
            <div class="imagem">
                ...
                <p class="legenda"> Disponibilizamos uma ampla gama de equipamentos e acessórios informáticos de alta
                    qualidade para melhorar a sua experiência tecnológica. </p>
            </div>
            <div class="imagem">
                <div class="tamanhoImagem">
                ...
                <p class="legenda"> Oferecemos equipamentos novos e usados, como monitores, impressoras, ratos e pen
                    drives, com preços acessíveis e garantia de qualidade. </p>
            </div>
            <div class="imagem">
                <div class="tamanhoImagem">
                ...
                <p class="legenda"> Garantimos a entrega de equipamentos em até 24 horas, para que você tenha o que
                    precisa com rapidez. </p>
            </div>
        </div>
        <div class="row">
            <div class="imagem">
                ...
                <p class="legenda"> Temos uma variedade de consumíveis, como toners, cartuchos e cabos, das melhores
                    marcas para garantir o bom funcionamento dos seus dispositivos. </p>
            </div>
            <div class="imagem">
                <div class="tamanhoImagem">
                ...
                <p class="legenda"> Realizamos reparações rápidas e eficientes em computadores, laptops e impressoras,
                    com diagnóstico preciso e consertos de qualidade. </p>
            </div>
            <div class="imagem">
                <div class="tamanhoImagem">
                ...
                <p class="legenda"> Oferecemos serviços de instalação de redes, software de faturação e equipamentos
                    informáticos, proporcionando soluções completas para o bom funcionamento da sua empresa. </p>
            </div>
        </div>
    </div>
</div>
...
<div class="container_or">
    <div class="orcamento-row">
        ...
        <div class="orcamento-item">
            <button id="orcamento-calc" type="button" class="btn btn-primary">Calcular</button>
        </div>
    </div>
    <div id="orcamento-calculado" class="text-center d-none">
...
<footer>
    ...
    <div class="termos_politicas">
        ...
        <a href="{{ route('politicaPrivacidade') }}" target="_blank" rel="noopener noreferrer">Politica &
            Privacidade</a>
    </div>
...
<script>
    $(document).ready(function () {
        ...
        $('#orcamento-calc').on('click', function (e) {
            e.preventDefault();
            e.stopPropagation();

            let categoria = $('#dispositivo').val();
            let servico = $('#servico').val();

            $.ajax({
                url: '/api/orcamento/' + categoria + '/' + servico,
                method: 'GET',
                success: function (response) {
                    $('#orcamento-calculado > p').html(`<strong>${response.total.toFixed(2)}€</strong><p>(POR HORA)</p>`);
                    $('#orcamento-calculado').removeClass('d-none');
                },
                error: function (xhr) {
                    alert('Erro ao carregar os serviços!');
                }
